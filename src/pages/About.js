                ...
                <div>
                    <div className="row align-items-center justify-content-between">
                        <div className="col-12 col-md-6 col-lg-5 discover_div">
                            ...
                            <p className="">Nous visons à prendre soin de vous. Besoin d'aide pour l'installation, trouver un bug ou simplement avoir besoin d'une clarification sur notre documentation? Nous serons là pour donner un coup de main.</p>
                            <div className="row">
                        ...
                        <div className="col-12 col-md-6">
                            <div className="row">
                                <div className="col-6 mt-8 mr-n5">
                                    <img src={photo1} alt="" className="photo1 img-fluid rounded mb-2 mr-4"></img>
                                    <img src={photo2} alt="" className="photo2 img-fluid rounded mr-4"></img>
                                </div>
                                <div className="col-6">
                                    <img src={photo3} alt="" className="photo3 img-fluid rounded mb-2 ml-4"></img>
                                    <img src={photo4} alt="" className="photo4 img-fluid rounded ml-4"></img>
                                </div>
                            </div>
                        </div>
                    </div>
